...
test('formatExpiryBreakdown lists each dated lot as DD.MM.YYYYxQTY', () => {
  const lots = [
    { expiryDate: '2026-03-01', currentQuantity: 2 },
    { expiryDate: '2027-07-01', currentQuantity: 3 },
    { expiryDate: null, currentQuantity: 9 },
  ];
...
test('buildIsoRows maps items to the 12 LY-F064 columns in order', () => {
  ...
  // storageLocation empty -> falls back to storageTemp; no dated lots -> "Yok"
